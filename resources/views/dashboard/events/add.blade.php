...
@section('title')
    <title>Architects - Add New Events</title>
@endsection
@section('styles')
        ...
        <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
            <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                <div>
                    ...
                    <h4 class="mg-b-0 tx-spacing--1">Add new Events to show for web visitors</h4>
                </div>
            </div>
                        ...
                        <fieldset class="form-fieldset mg-b-30" style="min-height:350px;">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control {{ $errors->has('name') ? ' has-error' : '' }}" name="name" placeholder="Enter event name" value="{{ old('name') }}" required>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="d-block">Event Date</label>
                                    <input type="date" class="form-control {{ $errors->has('date') ? ' has-error' : '' }}" name="date" placeholder="Enter event date" value="{{ old('date') }}" required>
                                </div>
                                <div class="col-md-12 form-group">
                                    <label class="d-block">Event Description</label>
                                    <div id="editor" class="ht-300">{!! old('desc') !!}</div>
                                    <input type="hidden" name="desc">
                                </div>
                                <div class="col-md-6 form-group mg-t-100">
                                    <label for="image">Event Thumbnail Image</label>
                                    <input type="file" name="img" class="form-control-file" id="image" onchange="readURL(this)" required>
                                </div>
                                <div class="col-md-6 form-group mg-t-100">
                                    <label>Preview Image</label>
                                    <img id="img" src="https://www.riobeauty.co.uk/images/product_image_not_found_thumb.gif" alt="Preview event thumbnail image" style="height:100px;display:block;">
                                </div>
                            </div>
                        </fieldset>
